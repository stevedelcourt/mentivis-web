...
function generateLlmsTxt() {
  ...
  const lines = [
    ...
    "- /fr/ambassadors - Programme Ambassadeurs Mentivis",
    ...
    "- /fr/mentivisos - MentivisOS, la plateforme pédagogique IA",
    ...
    "- /en/ambassadors - Mentivis Ambassador Program",
    ...
    "- /en/mentivisos - MentivisOS, the AI-native learning platform",
  ...
  for (const a of articles) {
    ...
    const titleFr = sanitize(a.titleFr || a.slug);
    const titleEn = sanitize(a.titleEn || a.titleFr || a.slug);
    const urlFr = `${BASE_URL}/fr/insights/${a.slug}`;
    const urlEn = `${BASE_URL}/en/insights/${a.slug}`;
    const date = a.date;
    const excerptFr = sanitize(a.excerptFr || "");
    const excerptEn = sanitize(a.excerptEn || "");
