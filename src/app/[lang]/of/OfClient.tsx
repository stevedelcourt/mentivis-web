...
export default function OfClient() {
  ...
  return (
    <PageShell hidePreFooterCTA>
      ...
      <ImageHero
        ...
        lead={o.heroLead}
      >
        <Link href={`/${lang}/contact/?subject=OF`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "white", background: "var(--m-purple)", borderRadius: 12, textDecoration: "none" }}>
          {t.nav.cta}
      ...
      <section style={{ padding: "60px 0", background: "var(--m-bg-soft)", borderTop: "1px solid var(--m-line)", borderBottom: "1px solid var(--m-line)" }}>
        <div className="container" style={{ maxWidth: 780 }}>
          <h2 style={{ fontSize: 24, fontWeight: 600, margin: "0 0 12px", color: "var(--m-ink)" }}>
            {lang === "fr" ? "Vous portez un projet de création ?" : "Starting a new training organization?"}
          </h2>
