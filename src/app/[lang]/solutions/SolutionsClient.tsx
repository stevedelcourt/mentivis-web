  ...
  return (
    <PageShell hidePreFooterCTA>
      ...
      <ImageHero
        ...
        lead={s.heroLead}
      >
        <Link href={`/${lang}/contact?subject=Solutions`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "white", background: "var(--m-purple)", borderRadius: 12, textDecoration: "none" }}>
          {t.nav.cta}
