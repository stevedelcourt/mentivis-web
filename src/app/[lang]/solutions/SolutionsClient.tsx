  ...
  return (
    <PageShell hidePreFooterCTA>
      ...
      <ImageHero
        ...
        lead={s.heroLead}
      >
        <Link href={`/${lang}/contact?subject=Solutions`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 20px", fontSize: 14, fontWeight: 600, color: "white", background: "var(--m-purple)", borderRadius: 999, textDecoration: "none" }}>
          {t.nav.cta}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: 48, alignItems: "start" }} className="m-julie-row">
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 14, paddingTop: 4 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: 8, fontSize: 14, color: "var(--m-ink-3)", marginTop: 4 }}>
                <Link href={`/${lang}/contact?subject=Solutions`} className="m-footer-link" style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
