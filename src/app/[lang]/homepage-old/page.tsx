...
export default function HomeOldPage() {
  ...
  return (
    <PageShell>
      ...
      <section style={{ paddingTop: "clamp(24px, 6vh, 96px)", paddingBottom: "clamp(12px, 2vh, 40px)", position: "relative" as const, overflow: "hidden" }}>
        <HomeHeroBackdrop />
        <div className="container" style={{ position: "relative" as const, zIndex: 1 }}>
          <Reveal>
            <div className="t-eyebrow" style={{ marginBottom: "clamp(8px, 1.5vh, 32px)" }}>
              {h.eyebrow}
            </div>
          </Reveal>
          <Reveal delay={80}>
            ...
            <p className="t-display" style={{ fontSize: heroSize, maxWidth: 1180, margin: "2px 0 0", lineHeight: 0.98, color: "var(--m-ink)" }}>
              {subtitleBlackWords}
            </p>
            <p className="t-display" style={{ fontSize: heroSize, maxWidth: 1180, margin: "2px 0 0", lineHeight: 0.98, color: "#000776" }}>
              {subtitleNavyWords}
            </p>
          </Reveal>
          <Reveal delay={160}>
            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 64, marginTop: "clamp(12px, 2.5vh, 56px)", alignItems: "end" }} className="m-home-leadgrid">
              ...
              <div style={{ display: "flex", gap: 12, justifyContent: "flex-end", flexWrap: "wrap" as const }}>
                ...
                <Link href={`/${lang}/about`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "var(--m-purple)", background: "transparent", border: "1.5px solid var(--m-purple)", borderRadius: 12, textDecoration: "none" }}>
                  {t.common.learnMore}
                  <Icon name="chevron_right" size={18} />
                </Link>
              </div>
