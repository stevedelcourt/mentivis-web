  ...
  return (
    <PageShell hidePreFooterCTA>
      <JsonLd data={{
        ...
        image: `${SITE.baseUrl}/images/heroes/men-enterprise.avif`,
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 48, alignItems: "center", padding: "40px 0", borderTop: "1px solid var(--m-line)" }} className="m-split-grid">
            ...
            <div>
              ...
              <Link href={`/${lang}/score-formation/`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "white", background: "var(--m-purple)", borderRadius: 12, textDecoration: "none" }}>
                {e.scoreTeaserCta}
                <Icon name="chevron_right" size={18} />
              </Link>
            </div>
